...
class DesignPrerequisiteTest {
    ...
    class 선후수_조건을_만족하는_경우 {
        ...
        void 설계_선후수_조건_검사1(int beforeYear, int beforeSemester, int afterYear, int afterSemester) {
            //given
            CompletedCourse basicCompletedCourse = CompletedCourse.builder().code(7620L).year(beforeYear).semester(beforeSemester).build();
            CompletedCourse elementCompletedCourse = CompletedCourse.builder().code(7721L).year(afterYear).semester(afterSemester).build();
        ...
        void 설계_선후수_조건_검사2() {
            //given
            CompletedCourse basicCompletedCourse = CompletedCourse.builder().code(7620L).year(2024).semester(2).build();
            CompletedCourse elementCompletedCourse = CompletedCourse.builder().code(7721L).year(2025).semester(1).build();
            CompletedCourse elementCompletedCourse2 = CompletedCourse.builder().code(9650L).year(2025).semester(2).build();
            CompletedCourse comprehensiveCompletedCourse = CompletedCourse.builder().code(9947L).year(2026).semester(1).build();
        ...
        void 설계_선후수_조건_검사3() {
            ...
            CompletedCourse basicCompletedCourse = CompletedCourse.builder().code(7620L).year(2024).semester(2).build();
            CompletedCourse elementCompletedCourse = CompletedCourse.builder().code(7721L).year(2025).semester(1).build();
            CompletedCourse elementCompletedCourse2 = CompletedCourse.builder().code(9650L).year(2026).semester(1).build();
            CompletedCourse comprehensiveCompletedCourse = CompletedCourse.builder().code(9947L).year(2026).semester(1).build();
        ...
        void 설계_선후수_조건_검사4() {
            //given
            CompletedCourse basicCompletedCourse = CompletedCourse.builder().code(7620L).year(2024).semester(2).build();
            CompletedCourse elementCompletedCourse = CompletedCourse.builder().code(7721L).year(2025).semester(2).build();
            CompletedCourse elementCompletedCourse2 = CompletedCourse.builder().code(9650L).year(2025).semester(2).build();
            CompletedCourse comprehensiveCompletedCourse = CompletedCourse.builder().code(9947L).year(2026).semester(1).build();
    ...
    class 선후수_조건을_만족하지_않는_경우 {
        ...
        void 설계_선후수_조건_검사1(int beforeYear, int beforeSemester, int afterYear, int afterSemester) {
            //given
            CompletedCourse elementCompletedCourse = CompletedCourse.builder().code(7721L).year(beforeYear).semester(beforeSemester).build();
            CompletedCourse basicCompletedCourse = CompletedCourse.builder().code(7620L).year(afterYear).semester(afterSemester).build();
        ...
        void 설계_선후수_조건_검사2(int beforeYear, int beforeSemester, int afterYear, int afterSemester) {
            //given
            CompletedCourse comprehensiveCompletedCourse = CompletedCourse.builder().code(9947L).year(beforeYear).semester(beforeSemester).build();
            CompletedCourse basicCompletedCourse = CompletedCourse.builder().code(7620L).year(afterYear).semester(afterSemester).build();
        ...
        void 설계_선후수_조건_검사3() {
            ...
            CompletedCourse basicCompletedCourse = CompletedCourse.builder().code(7620L).year(2024).semester(2).build();
            CompletedCourse elementCompletedCourse = CompletedCourse.builder().code(7721L).year(2025).semester(2).build();
            CompletedCourse comprehensiveCompletedCourse = CompletedCourse.builder().code(9947L).year(2025).semester(2).build();
        ...
        void 설계_선후수_조건_동시수강_검사1() {
            //given
            CompletedCourse basicCompletedCourse = CompletedCourse.builder().code(7620L).year(2024).semester(2).build();
            CompletedCourse elementCompletedCourse = CompletedCourse.builder().code(7721L).year(2024).semester(2).build();
        ...
        void 설계_선후수_조건_동시수강_검사2() {
            //given
            CompletedCourse basicCompletedCourse = CompletedCourse.builder().code(7620L).year(2024).semester(2).build();
            CompletedCourse comprehensiveCompletedCourse = CompletedCourse.builder().code(9947L).year(2024).semester(2).build();
