...
import com.gonghak98.v2.legacy.status.domain.GonghakCoursesDomain;
...
public interface GonghakCoursesRepository extends JpaRepository<GonghakCoursesDomain,Long> {
    ...
    @Query("select new com.gonghak98.v2.status.service.dto.CourseDetailsDto(GCD.coursesDomain.courseId, GCD.coursesDomain.name, CCD.year, CCD.semester, GCD.courseCategory, GCD.passCategory, GCD.designCredit, GCD.coursesDomain.credit) from GonghakCoursesDomain GCD "
    ...
    @Query("select new com.gonghak98.v2.status.service.dto.IncompletedCoursesDto(GCD.coursesDomain.name, GCD.courseCategory, GCD.coursesDomain.credit, GCD.designCredit) from GonghakCoursesDomain GCD  "
