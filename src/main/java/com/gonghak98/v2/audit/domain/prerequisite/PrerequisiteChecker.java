...
public class PrerequisiteChecker {
    ...
    public static boolean isSatisfiedPrerequisite(AuditCompletedCourse before, AuditCompletedCourse after) {
        return before.compareTo(after) < 0; // 선수 과목이 후수 과목보다 더 앞서야 선후수 조건을 만족
    }

    public static boolean isSatisfiedDesignPrerequisite(AuditCompletedCourse before, AuditCompletedCourse after) {
